...
namespace FMPI.Marketing.Core.Models
{
    public partial class GuestTransactions
    {
        ...
        public decimal? SysFkAccountGtrans { get; set; }
        ...
        public DateTime? DateActualGtrans { get; set; }
        public string TimeActualGtrans { get; set; }
        ...
        public string ModuleLedgerGtrans { get; set; }
        ...
        public string RemarksGtrans { get; set; }
        public string StatusGtrans { get; set; }
        public string TypeGtrans { get; set; }
        public string TelNumGtrans { get; set; }
    }
}
